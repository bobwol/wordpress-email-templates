        	...
        	<table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%">
            	<tr>
                	<td align="center" valign="top">
                    	<table border="0" cellpadding="0" cellspacing="0" width="<?php echo $settings['template'] == 'boxed' ? '95%' : '100%';?>" id="template_container" style="<?php echo $template_container; ?> max-width:680px;">
                        	<tr>
                            	<td align="center" valign="top">
                                    <!-- Header -->
